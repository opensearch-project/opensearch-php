...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\OpenSearch\ConnectionPool\StaticConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\OpenSearch\ConnectionPool\SimpleConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\OpenSearch\ConnectionPool\SniffingConnectionPool', [])
            ->build();
----
...
[source,php]
----
$connectionPool = '\OpenSearch\ConnectionPool\StaticNoPingConnectionPool';
$client = ClientBuilder::create()
