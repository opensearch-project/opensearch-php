...
/**
 * Tests the refreshable signing client decorator with the Symfony HTTP client.
 */
class RefreshableSigningClientDecoratorSymfonyTest extends TestCase
{
    public function testSymfonyRequestIsSigned(): void
    {
        ...
        $decorator = new RefreshableSigningClientDecorator(
            $symfonyPsr18Client,
            $credentialProvider,
            $signer,
            [
