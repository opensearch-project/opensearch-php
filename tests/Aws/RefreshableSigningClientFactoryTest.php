...
use OpenSearch\Aws\RefreshableSigningClientFactory;
...
/**
 * Tests the refreshable signing client factory.
 */
#[CoversClass(RefreshableSigningClientFactory::class)]
class RefreshableSigningClientFactoryTest extends TestCase
{
    public function testCreate(): void
    {
        ...
        $client = (new RefreshableSigningClientFactory())->create($symfonyClient, [
            'host' => 'example.com',
            'region' => 'us-east-1',
            'credentials' => [
                'access_key' => 'foo',
    ...
    public function testCreateWithCallableProvider(): void
    {
        ...
        $client = (new RefreshableSigningClientFactory(provider: $provider))->create($symfonyClient, [
            'host' => 'example.com',
            'region' => 'us-east-1',
        ]);
    ...
    public function testCreateWithDeprecatedCredentialProviderInstance(): void
    {
        ...
        try {
            $factory = new RefreshableSigningClientFactory(provider: new CredentialProvider());
        } finally {
    ...
    public function testValidateService(): void
    {
        ...
        (new RefreshableSigningClientFactory())->create($symfonyClient, [
            'host' => 'example.com',
            'region' => 'us-east-1',
            'service' => 'foo',
            'credentials' => [
