...
class SigningClientDecoratorTest extends TestCase
{
    ...
    public function testSendRequestWithDeprecatedArgs(): void
    {
        ...
        $this->expectUserDeprecationMessage('Passing ' . CredentialsInterface::class . ' as the $credentialProvider param in ' . SigningClientDecorator::class . '::__construct() is deprecated in 2.7.1 and will be removed in 3.0.0. Pass a callable instead.');
