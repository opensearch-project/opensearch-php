...
class Client
{
    ...
    public function __construct(Transport $transport, callable $endpoint, array $registeredNamespaces)
    {
        ...
        $this->machineLearning = new MachineLearningNamespace($transport, $endpoint);
    ...
    /**
     * Returns the machineLearning namespace
     */
    public function machineLearning(): MachineLearningNamespace
    {
